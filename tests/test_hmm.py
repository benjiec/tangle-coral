...
class TestHMMSearch(unittest.TestCase):
    ...
    def test_parse_hmmsearch_domtbl_returns_matches(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            self.assertEqual(matches[0]["evalue"], 0.05)
            self.assertEqual(matches[0]["score"], 201)
            ...
            self.assertEqual(matches[1]["evalue"], 0.04)
            self.assertEqual(matches[1]["score"], 202)
...
class TestAlignmentParsing(unittest.TestCase):
    ...
    def test_aligned_split_by_gap(self):
        x = Aligned(
            ...
            query_length = 100,
            hit_id = "t",
            full_aligned_evalue = 0.001,
            full_aligned_bitscore = 20,
