...
for line in manifest.strip().split("\n"):
    ...
    print(f"salmon quant -i {holobiont}_host.salmon_index -l A --validateMappings -p 2 -o host_quants/{sra_rec} -1 {sra_rec}_R1_001.fastq -2 {sra_rec}_R2_001.fastq")
    print(f"salmon quant -i {holobiont}_symb.salmon_index -l A --validateMappings -p 2 -o symb_quants/{sra_rec} -1 {sra_rec}_R1_001.fastq -2 {sra_rec}_R2_001.fastq")
