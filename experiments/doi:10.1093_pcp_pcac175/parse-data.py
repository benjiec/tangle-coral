...
metadata.append(dict(cohort="LowNutrient25C", term="NutrientLevel", value="balanced"))
...
metadata.append(dict(cohort="HighNutrient25C", term="NutrientLevel", value="balanced"))
...
metadata.append(dict(cohort="Imbalanced25C", term="NutrientLevel", value="imbalanced"))
...
metadata.append(dict(cohort="LowNutrient34C", term="NutrientLevel", value="balanced"))
...
metadata.append(dict(cohort="HighNutrient34C", term="NutrientLevel", value="balanced"))
...
metadata.append(dict(cohort="Imbalanced34C", term="NutrientLevel", value="imbalanced"))
